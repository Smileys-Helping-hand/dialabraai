...
export async function runAllMigrations() {
  try {
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS quotes_shop_slug_idx ON quotes(shop_slug)`;
    await sql`CREATE INDEX IF NOT EXISTS quotes_customer_email_idx ON quotes(customer_email)`;
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS notifications_user_email_idx ON notifications(user_email)`;
    await sql`CREATE INDEX IF NOT EXISTS notifications_user_type_idx ON notifications(user_type)`;
