    ...
    return (
      <>
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full bg-cream border border-charcoal/20 hover:border-flame hover:shadow-md transition-all text-sm font-semibold"
        >
